# Microsoft Developer Studio Project File - Name="shared_value" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** 編集しないでください **

# TARGTYPE "Win32 (x86) Dynamic-Link Library" 0x0102

CFG=shared_value - Win32 Debug
!MESSAGE これは有効なﾒｲｸﾌｧｲﾙではありません。 このﾌﾟﾛｼﾞｪｸﾄをﾋﾞﾙﾄﾞするためには NMAKE を使用してください。
!MESSAGE [ﾒｲｸﾌｧｲﾙのｴｸｽﾎﾟｰﾄ] ｺﾏﾝﾄﾞを使用して実行してください
!MESSAGE 
!MESSAGE NMAKE /f "shared_value.mak".
!MESSAGE 
!MESSAGE NMAKE の実行時に構成を指定できます
!MESSAGE ｺﾏﾝﾄﾞ ﾗｲﾝ上でﾏｸﾛの設定を定義します。例:
!MESSAGE 
!MESSAGE NMAKE /f "shared_value.mak" CFG="shared_value - Win32 Debug"
!MESSAGE 
!MESSAGE 選択可能なﾋﾞﾙﾄﾞ ﾓｰﾄﾞ:
!MESSAGE 
!MESSAGE "shared_value - Win32 Release" ("Win32 (x86) Dynamic-Link Library" 用)
!MESSAGE "shared_value - Win32 Debug" ("Win32 (x86) Dynamic-Link Library" 用)
!MESSAGE 
...
!IF  "$(CFG)" == "shared_value - Win32 Release"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib wsock32.lib /nologo /dll /debug /machine:I386 /out:"D:\ssp_src_set\ssp\plugin\shared_value/shared_value.dll" /pdbtype:sept

!ENDIF 

# Begin Target

# Name "shared_value - Win32 Release"
# Name "shared_value - Win32 Debug"
